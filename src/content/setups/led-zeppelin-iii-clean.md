...
- title: Guitarra Cort
  list:
  - <strong class="text-white">Captador:</strong> Braço (Neck)
  - <strong class="text-white">Volume:</strong> 7 (Limpar a saída)
...
- title: Joyo R12 EQ (10-Band)
  tagUso: Scoop de médios (Vibe Fender)
  table:
  - f: '31.2'
    db: '-2'
  - f: '62.5'
...
- title: Ambiência & Loop
  list:
  - <strong class="text-white">Mini Universe:</strong> SPRING | Mix 4.5 | Decay 4
    | Param 6
  - <strong class="text-white">Lost Tempo:</strong> d23 (Jazz/Blues) a 44 BPM
---
